...
Como ventajas que nos llevan a emplear este algoritmo, podemos citar que es computacionalmente eficiente, apropiado para problemas con muchos datos o altas dimensionalidades, poco afectado por gradientes dispersos o con mucho ruido. Su eficacia ha sido probada en distintos casos de uso reales.
...
\begin{table}[H]
  ...
  \begin{tabular}{|c|c|c|c|}
  \hline
  \textbf{Modelo} & \textbf{Parámetros} & \textbf{Media MSE} & \textbf{STD MSE} \\
  \hline
