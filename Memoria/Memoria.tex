...
La fila \emph{Dummy} se refiere a un regresor que siempre devuelve la media (con la clase de \lstinline{sklearn} \lstlisting{DummyRegressor(strategy="mean")}), evaluado sobre el conjunto de test.
